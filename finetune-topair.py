...
if __name__ == '__main__':
    ...
    topair_dataloader.get_dataset("finetune", topair_params, batch_size=cmd.batch_size)
    ...
    #joint_dataset_length = midair_dataloader.length 
    ...
    #joint_dataset_length = airsim_dataloader.length
    ...
    model.fit(data, epochs=model_checkpoint_cbk.resume_epoch + (10000 // joint_dataset_length) + 1,

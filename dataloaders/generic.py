...
class DataLoaderGeneric():
    ...
    def __init__(self, dataset_name):
        self.build_functions = {"train" : self._build_train_dataset,
                                ...
                                "valid" : self._build_eval_dataset,
    ...
    def _build_eval_dataset(self):
        ...
        print("BUILT EVALUATION DATASET")
        return dataset
    ...
    def _build_sequence_samples(self, data_sample):
        ...
        im_semantic = data_sample["semantic"]
        rot = data_sample["rot"]
    ...
    def _augmentation_step_flip(self):
        ...
        im_col, im_semantic, im_depth, rot, trans, c = tf.cond(pred, true_flip_h, do_nothing)
